...
const SearchInput = () => {
    ...
    //inputtaki güncel veriyi versin diye
        ...
        <div className="flex-1 flex items-center justify-center">
            ...
            >
                <Input 
                    ...
                    ref={inputRef}
                    placeholder="Search" //içi bosken gösterilen yazı
                    className="md:text-base placeholder:text-neutral-600 px-14 w-full border-none
